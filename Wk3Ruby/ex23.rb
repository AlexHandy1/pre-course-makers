# research what its supposed to do
require 'pubnub' # pulling in a module I can't access
require 'awesome_print' # pulling in a module I can't access

#adding a class to define font for certain colours?
class String 
...
#creating a hash with symbols for the demo console options
class DemoConsole
  ...
  def initialize
    ...
    welcome #launches welcome function for PubHub gem

    keys_option = select_keys #launches select keys function to highlight which demo API option want

    case keys_option.to_s #case...when structure to provide output for selecting different options
    when '1'
    ...
    when '3' #custom option
      ...
      # defaults to standards if input blank
